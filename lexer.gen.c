...
void *jq_yyalloc (yy_size_t  size , yyscan_t yyscanner)
{
	return (void *) malloc( size );
}

void *jq_yyrealloc  (void * ptr, yy_size_t  size , yyscan_t yyscanner)
{
...
void jq_yyfree (void * ptr , yyscan_t yyscanner)
{
	free( (char *) ptr );	/* see jq_yyrealloc() for (char *) cast */
}
